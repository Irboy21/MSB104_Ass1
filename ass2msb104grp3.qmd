...
model <- lm(gini ~ vekst, data = Vekst_data)
...
ggplot(Model_data_2017, aes(x = vekst, y = gini)) +
...
som vist i @fig-gini-growth ser vi at

# Del B: Utforsker andre determinanter for ulikhet

## Data Tilhenting

### Begrunnelse av variabler
