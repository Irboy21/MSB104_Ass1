...
\caption{Enkel regresjonsmodel.}\label{tbl-reg1}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
Model 1: GINI \textasciitilde{} Vekst
\end{minipage} \\
\midrule\noalign{}
\endfirsthead
\toprule\noalign{}
...
Table~\ref{tbl-reg1}) viser at økonomisk vekst (Vekst) har en positiv og
